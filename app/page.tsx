  ...
  return (
    <section className="bg-slate-50 py-20 sm:py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <FadeIn>
            <div className="inline-flex items-center gap-2 bg-[#00B4E6]/10 border border-[#00B4E6]/25 rounded-full px-3.5 py-1.5 mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-[#00B4E6] animate-pulse" aria-hidden="true" />
              <span className="text-[#00B4E6] text-xs font-semibold">IA faz. Você só aprova.</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-[#0B1E4A] mb-5 text-balance">
              Pruma executa — você só <span className="text-[#00B4E6]">decide o que importa</span>
            </h2>
            <p className="text-slate-500 text-lg leading-relaxed mb-8">
              A IA cuida de todo o trabalho operacional: padroniza, executa e registra cada etapa com precisão. Quando chega num ponto crítico, avisa no WhatsApp. Um toque — e a operação segue.
            </p>
            <ul className="space-y-4 mb-10">
              {[
                { title: "IA executa 100% do trabalho rotineiro", desc: "Sem intervenção humana para o que é repetitivo, padronizado ou previsível." },
                { title: "Você só toca nos pontos críticos", desc: "Aprovações, exceções e decisões que realmente precisam da sua autorização." },
                { title: "Escala sem contratar mais gente", desc: "Volume cresce, equipe não precisa crescer no mesmo ritmo." },
                { title: "Sistemas atualizados na hora", desc: "ERP, planilhas e notificações acionados automaticamente após cada decisão." },
                { title: "Auditoria completa de tudo", desc: "Registro de quem fez o quê, quando e com qual resultado — sem retrabalho." },
              ].map((item) => (
                <li key={item.title} className="flex items-start gap-3">
                  <span className="mt-1 shrink-0 w-5 h-5 rounded-full bg-[#00B4E6]/10 flex items-center justify-center text-[#00B4E6]">
                    <IconCheck className="w-3 h-3" />
            ...
            <div className="p-4 bg-[#00B4E6]/8 border border-[#00B4E6]/20 rounded-xl">
              <p className="text-[#0B1E4A] text-sm font-semibold">A Pruma executa com consistência de máquina. Você entra só quando a decisão é sua.</p>
            </div>
          </FadeIn>
